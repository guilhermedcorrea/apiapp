...
def executa_select():
    with db.engine.connect() as conn:
        ...
        get_pedidos = (text("""
            SELECT DISTINCT pbasico.[IdProduto],pbasico.[SKU],pbasico.[NomeProduto]
            ...
            ecliente.Bairro, ecliente.Endereco, ecliente.Complemento, ecliente.Cep, ecliente.Numero, ecliente.Observacao
